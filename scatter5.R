...
scatter <- scatter + geom_point() + geom_smooth(method = "lm",colour = "Red",se = F) +labs(x = "Exam Anxiety", y = "Exam Performance %")

print(scatter)

imageFile <- file.path(imageDirectory,"Scatter5.png")
ggsave(imageFile)
